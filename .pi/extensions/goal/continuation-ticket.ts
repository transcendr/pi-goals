...
import type { QueuedGoal } from "./queue-state";
...
export type ContinuationTicketOptions = { triggerTurn?: boolean; deliverAs?: "steer" | "followUp"; force?: boolean };
...
export function decideTerminalContinuationTicket(goal: GoalState | null, queue: QueuedGoal[], opts: ContinuationTicketOptions = {}): ContinuationTicket {
	...
	return { kind: "queueHandoff", reason, goalId: goal.goalId, queueId: head.queueId, ...opts };
}
