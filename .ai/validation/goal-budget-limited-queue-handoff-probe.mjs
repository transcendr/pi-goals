...
assert('tools hand off after budget edit to budgetLimited', tools.includes('updatedGoal.status === "budgetLimited"') && tools.includes('processTerminalGoalWorkflow(pi, ctx, { goal: updatedGoal') && tools.includes('triggerTurn: true'));
