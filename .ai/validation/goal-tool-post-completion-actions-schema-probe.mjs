...
assert('create_goal schema exposes post_completion_context', /post_completion_context: Type\.Optional\(PostCompletionContextParam\)/.test(tools));
assert('create_goal schema exposes post_completion_actions', /post_completion_actions: Type\.Optional\(Type\.Array\(PostCompletionActionParam\)\)/.test(tools));
assert('enqueue_goal schema exposes post_completion_context', /post_completion_context: Type\.Optional\(PostCompletionContextParam\)/.test(queueTools));
assert('enqueue_goal schema exposes post_completion_actions', /post_completion_actions: Type\.Optional\(Type\.Array\(PostCompletionActionParam\)\)/.test(queueTools));
