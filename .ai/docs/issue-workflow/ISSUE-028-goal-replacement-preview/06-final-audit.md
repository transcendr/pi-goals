...
protocol_compliance[8]{step,status,evidence}:
  ...
  protocol_read,pass,"01-protocol-read.md lists required skill/reference reads"
  grounded_research,pass,"02-grounded-research.md records inspected command/ui surfaces"
  design_lock,pass,"03-design-lock.md locks select-prompt preview design"
